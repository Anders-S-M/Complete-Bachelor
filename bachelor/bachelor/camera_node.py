...
class CameraNode(Node):
  ...
  def listener_callback(self, data):
    ...
    img = cv2.resize(img, None, fx=5, fy=10, interpolation=cv2.INTER_AREA)
    ...
    # Parameters for line correctly placed
    goalcoordinates = [int(width/2), 1000, int(width/2), -1000]
    cv2.line(img, (goalcoordinates[0], goalcoordinates[1]), (goalcoordinates[2], goalcoordinates[3]), (255, 255, 255), 1)
